...
const faqData: FAQ[] = [
  ...
  {
    id: 2,
    quest: "What is the difference between tutoring sessions and group lessons?",
    ans: "Our tutoring sessions are a 1-hour long, one-on-one academic help session with an experienced tutor. Our group lessons range from 1-2 hours, and they are taught in specific subjects by talented teachers.",
  },
  {
    id: 3,
